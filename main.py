...
# Solve the system of equations using the callback function
sol = solve_ivp(solve_fluid_flow, (0, 10), y0, method='BDF', t_eval=np.linspace(0, 10, 10000), events=progress_bar.update)
# sol = solve_ivp(solve_fluid_flow, (0, 10), y0, method='BDF')
